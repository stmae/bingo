...
//		InputStream is = jarFile.getInputStream(jarFile.getJarEntry(name));
	...
	public AnnotationParser initializeAnnotationParser(TaskMonitor tm) {
		annParser = new AnnotationParser(this, new HashSet<String>(), tm);
		return annParser;
	}

	public AnnotationParser initializeAnnotationParser(HashSet<String> genes, TaskMonitor tm) {
		annParser = new AnnotationParser(this, genes, tm);
		return annParser;
	}
